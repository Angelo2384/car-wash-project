      ...
      <div className={styles.contentContainer}>
        <div className={styles.textContent}>
          <h2 className={styles.heading}>
            WASH MORE.
            <br />
            <span className={styles.highlightText}>SAVE MORE.</span>
          </h2>
          <p className={styles.subheading}>
            Join the WashWizzy Membership for the ultimate convenience. Members
            receive complimentary house calls, priority booking, and exclusive
            savings on every detail.
          </p>
          ...
          <div className={styles.grid}>
            <div className={styles.freeTierCol}>
              ...
              <ul className={styles.list}>
                <li className={styles.listItem}>
                  ...
                  <span className={styles.listTextOff}>
            ...
            <div className={styles.memberTierCol}>
              ...
              <ul className={styles.list}>
                ...
                <li className={styles.listItem}>
                  <CheckCircle2 className={styles.checkIconOrange} />
                  <span className={styles.listTextOn}>
...
const styles = {
  ...
  backgroundContainer:
    "absolute inset-0 z-0 flex md:justify-end opacity-20 md:opacity-40",
  backgroundImage:
    "h-full w-full md:w-1/2 object-cover object-left mix-blend-luminosity grayscale",
  gradientOverlayRight:
    "absolute inset-0 bg-gradient-to-r from-charcoal via-charcoal/80 to-transparent md:to-transparent",
  gradientOverlayTop:
  ...
  tierTitleOff:
    "text-sm font-bold tracking-widest uppercase text-soft-gray mb-4",
  list: "space-y-4",
